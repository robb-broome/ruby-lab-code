...
void * ggc_alloc_splay_tree_cfstring_descriptor_htab (int sz, void * nl)
{
  return ggc_splay_alloc (gt_e_P19cfstring_descriptor4htab, sz, nl);
}

void * ggc_alloc_splay_tree_machopic_indirection_htab (int sz, void * nl)
{
  return ggc_splay_alloc (gt_e_P20machopic_indirection4htab, sz, nl);
}
