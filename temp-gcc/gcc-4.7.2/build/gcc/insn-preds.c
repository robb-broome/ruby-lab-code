...
#line 54 "../../gcc/config/i386/predicates.md"
{
...
#line 63 "../../gcc/config/i386/predicates.md"
{
...
{
  return (
#line 87 "../../gcc/config/i386/predicates.md"
(QI_REG_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 113 "../../gcc/config/i386/predicates.md"
...
#line 253 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 338 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 346 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 354 "../../gcc/config/i386/predicates.md"
...
#line 371 "../../gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 488 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 492 "../../gcc/config/i386/predicates.md"
...
#line 511 "../../gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 538 "../../gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
{
  return (
#line 561 "../../gcc/config/i386/predicates.md"
...
#line 569 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 599 "../../gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}
...
#line 618 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 626 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
(op == const0_rtx)) || (
#line 635 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 640 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 645 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 650 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 685 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 700 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 705 "../../gcc/config/i386/predicates.md"
...
#line 732 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 733 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx))));
}
...
#line 750 "../../gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 798 "../../gcc/config/i386/predicates.md"
{
...
#line 937 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 957 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1083 "../../gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1109 "../../gcc/config/i386/predicates.md"
...
#line 1117 "../../gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1178 "../../gcc/config/i386/predicates.md"
...
#line 1183 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
